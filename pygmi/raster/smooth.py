...
class Smooth(BasicModule):
    ...
    def setupui(self):
        ...
        gl_2.addWidget(self.lbl_1, 0, 0, 1, 1)
        gl_2.addWidget(self.sb_x, 0, 1, 1, 1)
        gl_2.addWidget(self.lbl_2, 1, 0, 1, 1)
        gl_2.addWidget(self.sb_y, 1, 1, 1, 1)
        gl_2.addWidget(self.lbl_3, 2, 0, 1, 1)
        gl_2.addWidget(self.sb_radius, 2, 1, 1, 1)
        gl_2.addWidget(self.lbl_4, 3, 0, 1, 1)
