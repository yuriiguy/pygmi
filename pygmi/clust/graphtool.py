# -----------------------------------------------------------------------------
# Name:        graphtool.py (part of PyGMI)
#
# Author:      Patrick Cole
...
class ScatterPlot(BasicModule):
    ...
    def setupui(self):
        ...
        gl_left.addWidget(lbl_combo3_left, 2, 0, 1, 1)
        gl_left.addWidget(self.cp_dpoly, 0, 2, 1, 1)
        gl_left.addWidget(self.cp_combo, 0, 1, 1, 1)
        gl_left.addWidget(self.cp_combo2, 1, 1, 1, 1)
        gl_left.addWidget(self.cp_combo3, 2, 1, 1, 1)
        gl_right.addWidget(lbl_combo_right, 0, 0, 1, 1)
        gl_right.addWidget(lbl_combo2_right, 1, 0, 1, 1)
        gl_right.addWidget(self.map_dpoly, 0, 2, 1, 1)
        gl_right.addWidget(self.map_combo, 0, 1, 1, 1)
